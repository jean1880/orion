(function () {
        ...
        angular.module('dogToolApp')
            ...
            function CalendarCtrl ($scope, $location, $timeout, factoryCalendar, FactoryJob, FactoryNote, $modal, $modalStack, EVENT_COLOURS, flash, $interval, $localStorage, $state) {
               var opened = false,
                   changeCount = 0,
                   temp = [];
